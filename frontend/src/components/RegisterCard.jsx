    ...
    return (
        <div className="shrink-0 w-fit grid items-center p-4 border-t-3 border-t-cyan-300
            ...
            <div className="flex mt-6 gap-5">
                <button id="register-user-btn" className="transition-colors hover:bg-cyan-900 cursor-pointer
                                 text-sm font-bold bg-cyan-600 rounded-lg px-5 pb-1.5 pt-1">Register
                </button>
